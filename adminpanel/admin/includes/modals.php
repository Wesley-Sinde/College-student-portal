...
<!-- Modal For Add downloadable Exam -->
<div class="modal fade" id="modalForExamdownloadable" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <form class="refreshFrm" id="addExamDownloadableExe" method="post">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="exampleModalLabel">Add downloadable Exam</h5>
          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">&times;</span>
          </button>
        </div>
        <div class="modal-body">
          <div class="col-md-12">
            ...
            <div class="form-group">
              ...
              <input type="" name="File_Name" class="form-control" placeholder="Input Exam File Name Title" required="">
            </div>
