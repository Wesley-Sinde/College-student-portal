...
if (isset($_POST['submitFeePay']) != "") {
    ...
    $insData = $conn->query("INSERT INTO newsandevents(messageId,title,meassage,description,CreatedBy)
        ...
        <div class="app-page-title">
            <div class="page-title-wrapper">
                <div class="page-title-heading">
                    <div style="border-bottom: 1px solid rgba(2, 145, 240, 0.3);">News/Event Center</div>
                </div>
            </div>
        </div>
        <hr>
                    ...
                    <form action="" style="background-color: white;" method="post" class="needs-validation" novalidate>
                        <div class="form-row">
                            ...
                            <small id="helpId" class="form-text text-muted">
                                Enter the Title Of The news/event
                            </small>
                            <div class="valid-feedback">
                                Correct!
                            </div>
                            <div class="invalid-tooltip">
                                Please choose a Title Name For Your news/event.
                            </div>
                        </div>
                        ...
                        <div class="form-row">
                            ...
                            <small id="helpId" class="form-text text-muted">
                                Enter the news/event
                            </small>
                            <div class="valid-feedback">
                                Correct!
                            </div>
                            <div class="invalid-tooltip">
                                Please Enter Your news/event.
                            </div>
                        </div>
                        ...
                        <div class="form-row">
                            ...
                            <div class="invalid-tooltip">
                                Please Description For Your news/event.
                            </div>
                        </div>
