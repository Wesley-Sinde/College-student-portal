...
<body class="body">
    ...
    <div class="app-header header-shadow">
        <div class="app-header__content">
            ...
            <h5 style="padding-right: 3%;" class="card-title">Cats Exam Entry</h5>
    </div>
    </div>
        ...
        <table id="tableList" class="mb-0 table mb-0 table table-bordered table-striped needs-validation">
            ...
            <tbody>
                ...
                ?>
                        <div class="form-row">
                            <tr>
                                <form method="post" id="productForm" action="../query/updateExamineeMarksCatExe.php" class="needs-validation">
                                    ...
                                    ?>
                                        <div class="col-md-6">
                                            <td style="  margin: 0;padding: 0;">
                                                <?php $ValueToDisplay = $selrow[strtolower($s . "cat")] ?>
                                                <input class="form-control needs-validation" style="border: none;" type="" value=" <?php echo $ValueToDisplay; ?>" 
                                                name="<?php echo $s ?>" placeholder="Input Marks">
                                            </td>
                                        </div>
                                    <?php } ?>
