                            ...
                            if ($selExmne->rowCount() > 0) {
                                while ($selExmneRow = $selExmne->fetch(PDO::FETCH_ASSOC)) { ?>
                                    <tr>
                                        ...
                                        <!-- $courseSelected . $year_level . $Term_level . $YearSelected . $Academic_level
                                        exmne_year_level . $Term . exmne_year_level . $Academic_level
                                -->
                                        <td>
                                            <?php
                                        ...
                                        <td>
                                            <!-- rel="facebox" -->
                                            <a href="home.php?page=updateExaminee&id=<?php echo $selExmneRow['exmne_id']; ?>" class="btn btn-sm btn-primary">Update</a>
