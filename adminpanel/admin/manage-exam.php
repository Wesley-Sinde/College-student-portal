...
<div class="app-main__outer">
        <div class="app-main__inner">
            ...
            <input type="" name="Unit_Code" class="form-control" placeholder="Input Course Code" required=""  value="<?php echo $selExamRow['Unit_Code']; ?>">
          </div>
                              ...
                              <div class="form-group">
                                ...
                                <select class="form-control" name="examLimit" required="">
                                  ...
                                  <option value="90">80 Minutes</option> 
                                </select>
                              </div>
